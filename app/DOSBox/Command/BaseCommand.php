...
abstract class BaseCommand
{
    ...
    abstract protected function execute(IOutputter $outputter);

    abstract protected function checkNumberOfParameters($numberOfParametersEntered);

    abstract protected function checkParameterValues(IOutputter $outputter);

    final public function checkParameters(IOutputter $outputter)
    {
    ...
    {
        if ($parameterIndex < 0 || $parameterIndex >= sizeof($this->params)) {
